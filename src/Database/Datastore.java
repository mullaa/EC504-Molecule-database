...
public class Datastore{
    ...
    public static String getMolecule(int CID) {
        ...
        try {
            ...
            prewrite = new FileWriter(obj4.toString()+".txt");
            //prewrite = new FileWriter("/Users/mulla/Desktop/molecule-database/hu/molecules" +obj4.toString()+".txt");
    ...
    public static void finaltest() {
        System.out.println("Data Pull Test");
        Datastore pulltest = new Datastore();
        for (int i = 1; i<4; i++) {
            pulltest.getMolecule(i);
        }
        System.out.println("");
        System.out.println("Data Pull Test Finished");
    }
